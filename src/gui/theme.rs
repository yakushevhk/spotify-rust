    ...
    vec![
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#21222c".into(),
                bg_card: "#2c2e3a".into(),
                bg_hover: "#343746".into(),
                bg_active: "#3e4155".into(),
                bg_elevated: "#2a2c3a".into(),
                bg_input: "#343746".into(),
                bg_selected: "#343746".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#0c0c0c".into(),
                bg_card: "#121212".into(),
                bg_hover: "#1c1c1c".into(),
                bg_active: "#262626".into(),
                bg_elevated: "#181818".into(),
                bg_input: "#232323".into(),
                bg_selected: "#1a1a1a".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#181825".into(),
                bg_card: "#242436".into(),
                bg_hover: "#2a2a3c".into(),
                bg_active: "#313144".into(),
                bg_elevated: "#232336".into(),
                bg_input: "#2a2a3c".into(),
                bg_selected: "#2a2a3c".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#1d2021".into(),
                bg_card: "#2c2c2c".into(),
                bg_hover: "#383838".into(),
                bg_active: "#3c3836".into(),
                bg_elevated: "#32302f".into(),
                bg_input: "#3c3836".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#242933".into(),
                bg_card: "#2e3440".into(),
                bg_hover: "#3b4252".into(),
                bg_active: "#434c5e".into(),
                bg_elevated: "#353b49".into(),
                bg_input: "#3b4252".into(),
                bg_selected: "#3b4252".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#001e27".into(),
                bg_card: "#073642".into(),
                bg_hover: "#0a4050".into(),
                bg_active: "#0d4a5c".into(),
                bg_elevated: "#073642".into(),
                bg_input: "#0a4050".into(),
                bg_selected: "#0a4050".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#13141c".into(),
                bg_card: "#1f2030".into(),
                bg_hover: "#292d42".into(),
                bg_active: "#333754".into(),
                bg_elevated: "#1f2030".into(),
                bg_input: "#292d42".into(),
                bg_selected: "#292d42".into(),
        ...
        BuiltInTheme {
            ...
            palette: Palette {
                ...
                bg_dark: "#21252b".into(),
                bg_card: "#2c313a".into(),
                bg_hover: "#353b45".into(),
                bg_active: "#3e4452".into(),
                bg_elevated: "#2c313a".into(),
                bg_input: "#353b45".into(),
                bg_selected: "#353b45".into(),
...
pub fn setup_theme(ctx: &egui::Context) {
    ...
    style.visuals = egui::Visuals {
        ...
        widgets: egui::style::Widgets {
            noninteractive: wv(p.bg_dark, p.text_primary),
            inactive: wv(p.bg_card, p.text_secondary),
        ...
        window_fill: p.bg_dark,
        panel_fill: p.bg_dark,
